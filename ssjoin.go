...
// Formula frozen by the P4b-F2-C0 bounds spike (stores/pebble/ssjoin_bounds_spike_test.go).
...
// import stores/pebble directly (import cycle: stores/pebble → gstream via
...
// satisfies this interface lives in stores/pebble/ssjoin_store_assert.go.
//
...
// frozen by the P4b-F2-C0 spike (stores/pebble/ssjoin_bounds_spike_test.go).
//
